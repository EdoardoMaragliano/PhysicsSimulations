...
int main(){
  ...
  BJ=2.37,10000 Converge
  rnd.SetSeed(1585231386);

  BJ=5,3000 Converge A
  rnd.SetSeed(1585232039);

  BJ=5,3000 Converge B
  rnd.SetSeed(1585232231);
  
  BJ=5,20000 Converge B (15min senza video)
  rnd.SetSeed(1585222552);

  PARTICELLE 4500
  BJ=5, 3000
  rnd.SetSeed(1585254565);  
*/
